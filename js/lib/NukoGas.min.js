...
export class NukoGas {
  ...
  async getGas() {
    ...
    return this.option.list = json, this.option.list.faster = (parseInt(this.option.list.fastest) + parseInt(this.option.list.fast)) / 2, this.option.price = parseInt(json[this.option.pref]), this.option.price
  }
  set limit(limit) {
